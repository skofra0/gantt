...
public class TreeGridGanttLayout extends HorizontalLayout implements GanttListener {
	...
	private final SerializableComparator<Step> defaultSortOrderByIndex = (Step s1, Step s2) -> Integer
			.compare(gantt.getSteps().indexOf(s1), gantt.getSteps().indexOf(s2));
	...
	/**
	 * Remove all child steps directed by the TreeGrid's hierarchical data source.
	 */
