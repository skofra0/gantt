...
public class Gantt extends AbstractComponent implements HasComponents {
  ...
  protected Map<String, String> timezoneJsonCache = new HashMap<>();
  ...
  private GanttServerRpc rpc = new GanttServerRpc() {
    ...
    @Override
    public void onPredecessorChanged(String newPredecessorStepUid, String forTargetStepUid, String clearPredecessorForStepUid) {
  ...
  public void removeSteps() {
    Set<Step> allSteps = new HashSet<>(stepComponents.keySet());
  ...
  private void updateCurrentDateAndTime() {
    getState().currentDate = currentDateFormatter.format(LocalDate.now(getTimeZone().toZoneId()));
    getState().currentHour = currentHourFormatter.format(LocalDateTime.now(getTimeZone().toZoneId()));
  ...
  protected String getTimeZoneJson(String id) {
    ...
    // read time zone json from TimeZoneConstants.properties.
    try (InputStream is = createTimeZonePropertiesInputStream(propertiesFileName); BufferedReader reader = createTimeZonePropertiesReader(is);) {
    ...
    // DEEM-MOD
    if (!"Europe/Oslo".equalsIgnoreCase(id)) {
      var json = getTimeZoneJson("Europe/Oslo");
      if (json != null) {
  ...
  protected void fireMoveEvent(String stepUid, String newStepUid, long startDate, long endDate, MouseEventDetails details) {
    AbstractStep step = getStep(stepUid);
    AbstractStep newStep = getStep(newStepUid);
    int previousStepIndex = (step instanceof Step) ? getStepIndex((Step) step) : getStepIndex(((SubStep) step).getOwner());
    ...
    fireEvent(new MoveEvent(this, step, step.getStartDate(), step.getEndDate(), newStepIndex, previousStartDate, previousEndDate, previousStepIndex, details));
  }
  ...
  protected void fireResizeEvent(String stepUid, long startDate, long endDate, MouseEventDetails details) {
    ...
    adjustDatesByAbstractStep(step);
    fireEvent(new ResizeEvent(this, step, step.getStartDate(), step.getEndDate(), previousStartDate, previousEndDate, details));
  }

  protected void firePredecessorChangeEvent(String newPredecessorStepUid, String forTargetStepUid, String clearPredecessorForStepUid) {
  ...
  public Registration addClickListener(ClickListener listener) {
    return addListener(ClickEvent.class, listener, ClickListener.GANTT_CLICK_METHOD);
  }

  /**
   * Add {@link MoveListener} to listen step's move events.
   */
  public Registration addMoveListener(MoveListener listener) {
    return addListener(MoveEvent.class, listener, MoveListener.GANTT_MOVE_METHOD);
  }
  ...
  public Registration addResizeListener(ResizeListener listener) {
    return addListener(ResizeEvent.class, listener, ResizeListener.GANTT_RESIZE_METHOD);
  }
   ...
   * change events.
   */
  public Registration addPredecessorChangeListener(PredecessorChangeListener listener) {
    return addListener(PredecessorChangeEvent.class, listener, PredecessorChangeListener.GANTT_PERDECESSORCHANGE_METHOD);
  }
  ...
  public void removePredecessorChangeListener(PredecessorChangeListener listener) {
    removeListener(PredecessorChangeEvent.class, listener, PredecessorChangeListener.GANTT_PERDECESSORCHANGE_METHOD);
  }
  ...
  public class MoveEvent extends Event {
    ...
    public MoveEvent(Gantt source, AbstractStep step, long startDate, long endDate, int stepIndex, long previousStartDate, long previousEndDate, int previousStepIndex, MouseEventDetails details) {
      super(source);
      this.step = step;
  ...
  public class ResizeEvent extends Event {
    ...
    public ResizeEvent(Gantt source, AbstractStep step, long startDate, long endDate, long previousStartDate, long previousEndDate, MouseEventDetails details) {
      super(source);
      this.step = step;
      this.startDate = startDate;
      this.endDate = endDate;
  ...
  public interface ClickListener extends SerializableEventListener {
    ...
    public static final Method GANTT_CLICK_METHOD = ReflectTools.findMethod(ClickListener.class, "onGanttClick", ClickEvent.class);

    public void onGanttClick(ClickEvent event);
  }

  public interface MoveListener extends SerializableEventListener {

    public static final Method GANTT_MOVE_METHOD = ReflectTools.findMethod(MoveListener.class, "onGanttMove", MoveEvent.class);
  ...
  public interface ResizeListener extends SerializableEventListener {
    ...
    public static final Method GANTT_RESIZE_METHOD = ReflectTools.findMethod(ResizeListener.class, "onGanttResize", ResizeEvent.class);

    public void onGanttResize(ResizeEvent event);
  }

  public interface PredecessorChangeListener extends SerializableEventListener {
    public static final Method GANTT_PERDECESSORCHANGE_METHOD = ReflectTools.findMethod(PredecessorChangeListener.class, "onPredecessorChange", PredecessorChangeEvent.class);
